    ...
    return (
        <section className="min-h-[800px] bg-white pt-10 pb-20 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-rose-500 to-orange-500 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-rose-200">
                ...
                >
                    {TEAM_STATS.map((stat, i) => (
                        <div
                            key={i}
                            className="bg-gray-50 rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-transparent hover:border-rose-100"
                        >
                ...
                <motion.div
                    ...
                    className="bg-gradient-to-br from-rose-50 to-orange-50 rounded-3xl p-8 md:p-12 mb-16 border border-rose-100 shadow-sm"
                >
                    <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center md:text-left">Our Mission</h3>
                    <p className="text-gray-600 leading-relaxed text-lg text-center md:text-left">
                        ...
                        estimate in <strong>Indian Rupees (₹)</strong>. Whether you are listing a cozy apartment
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {FEATURES.map((feature, i) => (
                            <motion.div
                                ...
                                className="bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 group cursor-default"
                            >
                                <div className="w-12 h-12 rounded-full bg-rose-50 text-rose-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                                    <feature.icon className="w-6 h-6" />
                                </div>
                                <h4 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-rose-500 transition-colors">
                                    {feature.title}
                                </h4>
